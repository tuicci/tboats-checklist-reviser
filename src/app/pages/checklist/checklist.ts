...
export class ChecklistPage {
  ...
  @ViewChild('checklistList') checklistList: List;
  ...
  ionViewWillEnter() {
    // this.app.setTitle('checklist');
    this.updateChecklist();
  }

  updateChecklist() {
    // Close any open sliding items when the checklist updates
    if (this.checklistList) {
